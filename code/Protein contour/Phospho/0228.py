...
print("=" * 60)
print("📋 0220 Meeting 修改汇总")
print("=" * 60)
print()
print("✅ Figure 2 (新): Within-Group High vs Low Mobility")
print("   → S 和 T 分别做，4 spatial groups × 2 AA")
print("   → 小提琴 split, permutation KS, 显著性标注")
print("   → 文件: Fig2_WithinGroup_HighLow_v2.tiff")
print()
print("✅ Figure 3 (增强): Between-Group Heatmap")
print("   → 新增 Δmean（方向 + 大小），蓝=正 红=负")
print("   → 大字体，格子清晰")
print("   → 文件: Fig3_BetweenGroup_Heatmap_v6.tiff")
print()
print("✅ Control Analysis: Phospho vs Non-phospho (context-matched)")
print("   → ±2 AA 窗口匹配非磷酸化 S/T 作为对照")
print("   → 文件: Fig_Control_Phospho_vs_NonPhospho.tiff")
print()
print("📌 所有图均为 TIFF 格式，Arial 字体，大号标注")
print("📌 适合直接放入 PPT 使用")
print()
print("⚠ 注意事项:")
print("  1. Cell D (对照组) 需要 JSON_FOLDER 可访问")
print("  2. PTM_collapse_key 解析逻辑可能需要微调")
print("     → 如果报错，请打印 high_phospho['PTM_collapse_key'].head(20)")
print("     → 告诉我格式，我帮你修改正则")
print("  3. 导师提到的 Pathmanaban MD paper 佐证:")
print("     phospho-T(309) 对 dynamics 影响 > phospho-S(307)")
print("     → 与你的 Fig3 T > S 效应一致，proposal 中可引用")
